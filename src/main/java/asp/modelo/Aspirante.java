...
public class Aspirante extends Persona implements Serializable{
	...
	public Aspirante(long id_p, String nombres, String apellidos, String telefono, String correo, LocalDate fecha_reg, ProgAcad pro_acad)
	{
	...
	public String toString() {
		return "Aspirante [fecha_reg=" + fecha_reg + ", pro_acad=" + pro_acad + "]";
	}
}
